...
public class HighestPercentageSpecSymp {
	...
	public void higestPercentageMatchSpec() {
		...
		kSession.insert(s2); //both disease1 and disease2 contains s2
		...
		assertTrue(makingDiagnose.getSpecificSymptomsMatchedNum()==1L);
		assertTrue(makingDiagnose.getDisease().equals(testDisease2)); //but disease2 contains 50% of matched specific symptoms
